...
//		System.out.println("El estado " + state + " No tiene transicion con " + sigma + " esta cadena no es aceptada");
	...
	public AutomataAFD3(String[] alphabet, String[] states, String state0, String[] acceptationState,
			String[] transition) {
...
//				System.out.println(linea + "\t\t" + linea.length());
			...
			///////
			AutomataAFD3 prueba = new AutomataAFD3(alphabet, states, state0, acceptationState, transition);
